---
title: "Overview"
description: "Endpoint DLP for AI traffic. A signed desktop agent intercepts LLM calls at the OS network layer and routes them through Antidote so nothing reaches a public model unscanned."
---

Antidote DLP is the **endpoint** half of the runtime story. A signed
...
every prompt through Antidote for verdict and policy enforcement
