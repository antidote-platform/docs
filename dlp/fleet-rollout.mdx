...
This is how a company rolls Antidote DLP out "like AD": one silent
...
The MSI writes `HKLM\SOFTWARE\Antidote`, imports the root CA to the
...
Certain steps **cannot** be done inside Antidote's source tree.
