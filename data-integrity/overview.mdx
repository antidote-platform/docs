---
title: "Overview"
description: "What Data Integrity does, the core vocabulary, and the severity scale that every scan rolls up to."
---

Antidote Data Integrity scans your datasets for the problems that
...
gaps. It then helps you triage, fix, report, and audit the results.
...
<Steps>
  ...
  <Step title="Connect a data source">
    ...
    [Integrations](/data-integrity/integrations) page.
  </Step>
...
<Tip>
  ...
  dataset table, the dashboard widgets, the compliance report cover
  page, and webhook payloads. Treat it as the single‑number summary.
</Tip>

## Where to next

<CardGroup cols={2}>
  <Card title="Projects" icon="folder-tree" href="/data-integrity/projects">
    Organize datasets, schedules, and report templates by team or
    initiative.
  </Card>
  <Card title="Datasets" icon="database" href="/data-integrity/datasets">
    Upload, branch, version, and explore your data.
  </Card>
  <Card title="Running scans" icon="play" href="/data-integrity/scans">
