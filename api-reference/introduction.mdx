---
title: "API Reference"
description: "The Antidote Cloud REST and WebSocket surface, organized by product area."
---

Antidote exposes two OpenAPI-documented surfaces. Pick the one that
matches what you're integrating with.

<Columns cols={2}>
  <Card title="Antidote API" icon="shield-check">
...
- Wire Runtime Security with the [Runtime Security guide](/runtime-security/guide).
