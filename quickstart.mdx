...
This walkthrough takes you from a new Antidote Cloud workspace to a
scanned dataset and a first Runtime Security verdict. Plan on about
ten minutes.

## Prerequisites

- An Antidote Cloud workspace. If you don't have one yet, contact
...
<Tabs>
  <Tab title="Images (mislabel scan)">
    ...
    2. Either zip a folder where each subdirectory is a class
       (`cat/`, `dog/`, ...) and drop the zip, or point Antidote at a
    ...
    See [the user guide](/data-integrity/user-guide#5-running-a-scan)
    for the other engines (broad / CLIP, poisoning, 3D, text).
  </Tab>
...
[Runtime Security guide](/runtime-security/guide).

## Where to next

<CardGroup cols={2}>
  <Card title="User guide" icon="book-open" href="/data-integrity/user-guide">
    The full Data Integrity surface: projects, healing, compliance,
    audit, custom rules.
  </Card>
  ...
  <Card title="Architecture" icon="diagram-project" href="/data-integrity/architecture">
    The services, queues, and data flow behind the scenes.
  </Card>
