---
title: "Reverse proxy"
description: "Wire-compatible passthrough endpoints for OpenAI, Anthropic, Gemini, Vertex, Bedrock, and self-hosted runtimes. Swap one config value to put Antidote in front of LLM traffic."
---
